...
public class ForgottenMagicBookItem extends Item {

    public ForgottenMagicBookItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents,
        ...
        if (data.contains("grimoire")) {
            ...
            if (grim.contains("spell")) {
                tooltipComponents
                        .add(Component.translatable("tooltip.ancestral_arcane.spell", grim.getString("spell")));
            }
        }
