package com.dntr.item;

import com.dntr.data.CustomDataUtil;
import com.dntr.magic.casting.CastResolver;
import com.dntr.magic.spells.SpellExecutor;
...
public class ArcaneSpearFocusItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        CompoundTag data = CustomDataUtil.getDntrData(stack);
    ...
    public void releaseUsing(ItemStack stack, Level level, LivingEntity entityLiving, int timeLeft) {
        ...
        data.put("rune", rune);
        CustomDataUtil.setDntrData(stack, data);
    ...
    private void degradeRune(ServerPlayer player, ItemStack stack, CompoundTag data, CompoundTag rune,
        ...
        if (maxedDirty || noCharges) {
            ...
            if (lvl <= 0) {
                ...
                player.drop(new ItemStack(com.dntr.registry.DntrItems.ARCANE_RESIDUE.get(), residues), false);

                if (crafted == 1) {
                    ItemStack emptyRune = new ItemStack(com.dntr.registry.DntrItems.RUNE.get());
                    ...
                    CustomDataUtil.setDntrData(emptyRune, emptyData);
