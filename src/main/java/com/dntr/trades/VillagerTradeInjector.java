...
@EventBusSubscriber(modid = com.dntr.DntrMod.MODID)
public class VillagerTradeInjector {
    ...
    private static class MagicTradeListing implements VillagerTrades.ItemListing {
        ...
        public MerchantOffer getOffer(Entity trader, RandomSource random) {
            ...
            if (chance < 0.02f) { // 2%
                ItemStack grim = new ItemStack(DntrItems.GRIMOIRE_T4.get());
                ...
                ItemStack grim = new ItemStack(DntrItems.GRIMOIRE_T2.get());
                CompoundTag gd = new CompoundTag();
                gd.putString("kind", "grimoire");
                gd.putInt("tier", 2);
                gd.putInt("uses", 10);
                ...
                ItemStack grim = new ItemStack(DntrItems.GRIMOIRE_T1.get());
                CompoundTag gd = new CompoundTag();
                gd.putString("kind", "grimoire");
                gd.putInt("tier", 1);
                gd.putInt("uses", 10);
